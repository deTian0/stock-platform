...
$required = @(
  ...
  'docs/ops/engine-market-db.md',
  'docs/ops/broker-port-honesty.md',
  'docs/ops/m-d6-batch-recipe-upstream-feedback.md',
  'docs/README.md',
  'docs/plans/README.md',
  'docs/plans/workspace-projects-capability-inventory.md',
  'docs/plans/capability-domain-merge-roadmap.md',
  'docs/plans/usable-recommend-review-milestones.md',
  'docs/plans/market-report-dashboard-merge-milestones.md',
  'docs/plans/m-d1-capability-gap-matrix.md',
  'docs/plans/m-r1-tsp-backtest-first-knife.md',
  'docs/plans/m-a1-tradingagents-portability.md',
  'docs/engineering/README.md',
  'docs/engineering/openapi-testing-ci.md',
  'docs/upstream/README.md',
  'docs/upstream/a-stock-data-em-get-recipe.md',
  'docs/upstream/global-stock-symbol-semantics.md',
  'docs/upstream/a-stock-engine-lvrev-notes.md',
  'docs/upstream/tick-stock-panel-notes.md',
  'docs/upstream/tradingagents-roles-notes.md',
  'docs/upstream/v2-execution-safety-notes.md',
  'docs/upstream/market-report-dashboard-capability-report.md',
  'docs/upstream/market-report-templates/README.md',
